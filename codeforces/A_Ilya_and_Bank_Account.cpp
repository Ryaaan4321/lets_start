...
void galat_Karam()
{
    ...
    /*n: This is straightforward. It's the original number.

 n/10: This takes n and divides it by 10. This operation effectively removes the last digit from n.
  For example, if n is 123, n/10 will be 12.

 (n/100)*10 + n%10: This expression is a bit more complicated.

 n/100 removes the last two digits from n. For example, if n is 12345, n/100 will be 123.
 n%10 gives the last digit of n. For example, if n is 12345, n%10 will be 5.
 (n/100)*10 + n%10 combines the above two operations. It effectively removes the last two
  digits from n, then adds the last digit back to it. For example, if n is 12345, (n/100)*10 + n%10 will be 1230 + 5 = 1235.
 max(x, y): This function returns the maximum of two numbers x and y.*/
}
